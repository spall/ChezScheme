...
#define c_entry_name_vector #(thread-context get-thread-context handle-apply-overflood handle-docall-error handle-overflow handle-overflood handle-nonprocedure-symbol thread-list split-and-resize raw-collect-cond raw-tc-mutex handle-values-error handle-mvlet-error handle-arg-error foreign-entry install-library-entry get-more-room scan-remembered-set instantiate-code-object Sreturn Scall->ptr Scall->fptr Scall->bytevector Scall->fixnum Scall->int32 Scall->uns32 Scall->double Scall->single Scall->int64 Scall->uns64 Scall->void Scall->indirect-byte Scall->indirect-short Scall->indirect-int32 Scall->indirect-int64 Scall->indirect-float Scall->indirect-double Scall->indirect-copy-three-chars Scall->indirect-copy Scall->indirect-sized-int64-int64 Scall->indirect-sized-double-double Scall->indirect-sized-int64-double Scall->indirect-sized-double-int64 Scopy-argument)
#define c_entry_vector_size 0x2C
...
#define CENTRY_Scall_indirect_copy 38
#define CENTRY_Scall_indirect_copy_three_chars 37
...
#define CENTRY_Scall_indirect_sized_double_double 40
#define CENTRY_Scall_indirect_sized_double_int64 42
#define CENTRY_Scall_indirect_sized_int64_double 41
#define CENTRY_Scall_indirect_sized_int64_int64 39
...
#define CENTRY_Scopy_argument 43
