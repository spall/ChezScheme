...
#define library_entry_vector_size 0x214
...
#define tc_alloc_counter_disp 0x268
...
#define tc_instr_counter_disp 0x260
...
#define tc_parameters_disp 0x270
...
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+616)))
...
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+608)))
...
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+624)))
