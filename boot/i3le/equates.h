...
#define tc_alloc_counter_disp 0x12C
...
#define tc_instr_counter_disp 0x124
...
#define tc_parameters_disp 0x134
...
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+300)))
...
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+292)))
...
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+308)))
