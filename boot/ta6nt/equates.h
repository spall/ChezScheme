...
#define tc_U_disp 0x168
#define tc_V_disp 0x170
#define tc_W_disp 0x178
#define tc_X_disp 0x180
#define tc_Y_disp 0x188
#define tc_ac0_disp 0x28
#define tc_ac1_disp 0x30
#define tc_active_disp 0x134
#define tc_alloc_counter_disp 0x280
...
#define tc_disable_count_disp 0x1A0
...
#define tc_instr_counter_disp 0x278
...
#define tc_parameters_disp 0x288
...
#define tc_signal_interrupt_pending_disp 0x1A8
#define tc_something_pending_disp 0x190
...
#define tc_timer_ticks_disp 0x198
...
#define GUARDIANORDERED(x) (*((ptr *)((uptr)(x)+32)))
#define GUARDIANPENDING(x) (*((ptr *)((uptr)(x)+40)))
...
#define INITGUARDIANORDERED(x) (*((ptr *)((uptr)(x)+32)))
#define INITGUARDIANPENDING(x) (*((ptr *)((uptr)(x)+40)))
...
/* thread-context data */
#define U(x) (*((ptr *)((uptr)(x)+360)))
#define V(x) (*((ptr *)((uptr)(x)+368)))
#define W(x) (*((ptr *)((uptr)(x)+376)))
#define X(x) (*((ptr *)((uptr)(x)+384)))
#define Y(x) (*((ptr *)((uptr)(x)+392)))
#define AC0(x) (*((void* *)((uptr)(x)+40)))
#define AC1(x) (*((void* *)((uptr)(x)+48)))
#define ACTIVE(x) (*((I32 *)((uptr)(x)+308)))
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+640)))
...
#define DISABLECOUNT(x) (*((ptr *)((uptr)(x)+416)))
...
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+632)))
...
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+648)))
...
#define SIGNALINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+424)))
#define SOMETHINGPENDING(x) (*((ptr *)((uptr)(x)+400)))
...
#define TIMERTICKS(x) (*((ptr *)((uptr)(x)+408)))
