...
#define code_flag_single_valued 0x8
...
#define mask_code_single_valued 0x8FF
...
#define tc_block_counter_disp 0x1E0
...
#define tc_current_error_disp 0x1D8
#define tc_current_input_disp 0x1C8
#define tc_current_mso_disp 0x1F0
#define tc_current_output_disp 0x1D0
...
#define tc_fxfirst_bit_set_bv_disp 0x208
#define tc_fxlength_bv_disp 0x200
...
#define tc_keyboard_interrupt_pending_disp 0x1B8
#define tc_lz4_out_buffer_disp 0x290
#define tc_meta_level_disp 0x230
#define tc_null_immutable_bytevector_disp 0x220
#define tc_null_immutable_fxvector_disp 0x218
#define tc_null_immutable_string_disp 0x228
#define tc_null_immutable_vector_disp 0x210
...
#define tc_target_machine_disp 0x1F8
#define tc_td_disp 0x88
#define tc_threadno_disp 0x1C0
...
#define type_code_single_valued 0x83E
...
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+672)))
#define AP(x) (*((void* *)((uptr)(x)+80)))
#define ARGREGS(x,i) (((void* *)((uptr)(x)+0))[i])
#define ATTACHMENTS(x) (*((ptr *)((uptr)(x)+352)))
#define BLOCKCOUNTER(x) (*((ptr *)((uptr)(x)+480)))
#define CACHEDFRAME(x) (*((ptr *)((uptr)(x)+360)))
#define CCHAIN(x) (*((ptr *)((uptr)(x)+288)))
#define CODERANGESTOFLUSH(x) (*((ptr *)((uptr)(x)+296)))
#define COMPILEPROFILE(x) (*((ptr *)((uptr)(x)+568)))
#define COMPRESSFORMAT(x) (*((ptr *)((uptr)(x)+640)))
#define COMPRESSLEVEL(x) (*((ptr *)((uptr)(x)+648)))
#define CP(x) (*((void* *)((uptr)(x)+64)))
#define CURRENTERROR(x) (*((ptr *)((uptr)(x)+472)))
#define CURRENTINPUT(x) (*((ptr *)((uptr)(x)+456)))
#define CURRENTMSO(x) (*((ptr *)((uptr)(x)+496)))
#define CURRENTOUTPUT(x) (*((ptr *)((uptr)(x)+464)))
#define DEFAULTRECORDEQUALPROCEDURE(x) (*((ptr *)((uptr)(x)+624)))
#define DEFAULTRECORDHASHPROCEDURE(x) (*((ptr *)((uptr)(x)+632)))
#define DISABLECOUNT(x) (*((ptr *)((uptr)(x)+424)))
#define EAP(x) (*((void* *)((uptr)(x)+88)))
#define ESP(x) (*((void* *)((uptr)(x)+72)))
#define FXFIRSTBITSETBV(x) (*((ptr *)((uptr)(x)+520)))
#define FXLENGTHBV(x) (*((ptr *)((uptr)(x)+512)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)((uptr)(x)+576)))
#define GENERATEPROCEDURESOURCEINFORMATION(x) (*((ptr *)((uptr)(x)+584)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)((uptr)(x)+592)))
#define GUARDIANENTRIES(x) (*((ptr *)((uptr)(x)+280)))
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+664)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+440)))
#define LZ4OUTBUFFER(x) (*((void* *)((uptr)(x)+656)))
#define METALEVEL(x) (*((ptr *)((uptr)(x)+560)))
#define NULLIMMUTABLEBYTEVECTOR(x) (*((ptr *)((uptr)(x)+544)))
#define NULLIMMUTABLEFXVECTOR(x) (*((ptr *)((uptr)(x)+536)))
#define NULLIMMUTABLESTRING(x) (*((ptr *)((uptr)(x)+552)))
#define NULLIMMUTABLEVECTOR(x) (*((ptr *)((uptr)(x)+528)))
#define OPTIMIZELEVEL(x) (*((ptr *)((uptr)(x)+600)))
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+680)))
...
#define SUBSETMODE(x) (*((ptr *)((uptr)(x)+608)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)((uptr)(x)+616)))
#define TARGETMACHINE(x) (*((ptr *)((uptr)(x)+504)))
#define TD(x) (*((void* *)((uptr)(x)+136)))
#define THREADNO(x) (*((ptr *)((uptr)(x)+448)))
