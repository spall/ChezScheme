...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; variable parameters
  ...
  (record-source-lines-and-columns [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (file-position-object? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (file-position-object-position [sig [(ptr) -> (uint)]] [flags pure mifoldable discard])
  (file-position-object-line [sig [(ptr) -> (uint)]] [flags pure mifoldable discard])
  (file-position-object-column [sig [(ptr) -> (uint)]] [flags pure mifoldable discard])
  ...
  (make-file-position-object [sig [(uint uint uint) -> (ptr)]] [flags pure true mifoldable discard])
  ...
  (make-source-object [sig [(sfd ptr ptr) -> (source-object)]] [flags pure true mifoldable discard])
  ...
  (source-file-descriptor-lines-done! [sig [(sfd) -> (void)]] [flags true])
