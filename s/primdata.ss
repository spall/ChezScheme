...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (fxpopcount [sig [(fixnum) -> (fixnum)]] [flags arith-op cp02 safeongoodargs])
  (fxpopcount32 [sig [(fixnum) -> (fixnum)]] [flags arith-op cp02 safeongoodargs])
  (fxpopcount16 [sig [(fixnum) -> (fixnum)]] [flags arith-op cp02 safeongoodargs])
